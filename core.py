        ...
        "parcours":[
           {
               ...
               "detail": "Toutes les entreprises (publiques ou privées) ne peuvent plus se passer de l'outil informatique surtout l'informatique appliquée à la gestion. La filière Informatique de Gestion Génie Logiciel et Intelligence Artificielle est une filière dont l'objectif est la formation d'Ingénieurs et de Techniciens Supérieurs capables de maîtriser toutes les techniques informatiques relatives à la gestion des entreprises.",
           },
           {
        ...
        "parcours":[
           {
               ...
               "detail": "Les différentes industries agroalimentaires ont une place et un rôle important dans notre économie. L'ISPM a comme objectif de former des cadres de qualité pour ces entreprises.",
           },
           {
               "leash": "Pharmacologie et Industrie Pharmaceutiques",
               "detail": "L'existence des plantes médicinales endémiques est une réalité à Madagascar. L'ISPM veut mettre en valeur les propriétés therapeutiques de ces plantes d'une manière scientifique.",
           },
           {
               "leash": "Agriculture et Elevage",
               "detail": "Plus de 80% de Malagasy vivent et travaillent dans le monde rural. Par ailleurs, il est clair que le secteur primaire est un des secteurs fondamentaux dans l'économie d'un pays. C'est dans ce sens qu'a été créée la filière Agriculture et élevage car il nous faut des jeunes capables d'appliquer les techniques et les technologies modernes dans le monde rural. Ils sont aussi formés au concept de l'agri-business.",
           },
        ],
    },
    {
        ...
        "parcours":[
            {
                ...
                "detail": "La construction des infrastructures est un élément fondamental pour améliorer le niveau de vie d'un pays. C'est pourquoi l'ISPM forme à travers sa filière Génie Civil et Architecture les jeunes qui vont améliorer non seulement les infrastructures mais participer à l'aménagement urbain et rural."
            },
        ],
    },
    {
...
def details(sender_id, lang, parcours, cmd, **extends):
    ...
    '''
        Print detail of parcour checked
    '''